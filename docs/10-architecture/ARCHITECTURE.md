...
ADR-0010 and ADR-0011. `@tenancyjs/adapter-knex` is implemented with hosted Node 22/24 PostgreSQL 17
evidence; the distinct Lucid and Adonis layers remain in progress.
