...
Core names above are implemented contracts. `TenantResolver`, `TenancyAdapter`, `TenancyIntegration`,
and conformance-suite details remain planned until their tasks complete. Do not introduce a competing
