...
- AC-04: A real MongoDB 8 replica-set suite proves two tenants with the same `_id` cannot read/update/
  delete each other and proves rollback, concurrency, and session cleanup.
