...
Status: Complete — ADR-0010 and ADR-0012 accepted.

Scope: Complete F-007/module memory and review ADR-0010/ADR-0012.
...
Tests: Two-tenant CRUD/bulk/aggregate/transaction/concurrency/rollback/bypass matrix on Node 22/24.
...
Status: Blocked on T4; ADR-0012 is accepted
...
clean package consumers, and a dedicated Node 24 AdonisJS 7 CI lane.
