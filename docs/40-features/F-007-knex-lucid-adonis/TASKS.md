...
Status: Complete — ADR-0010 and ADR-0011 accepted.

Scope: Complete F-007/module memory and review ADR-0010/ADR-0011.
...
Status: Blocked on T4 and ADR-0011 acceptance
...
clean package consumers, and Node 22/24 CI.
