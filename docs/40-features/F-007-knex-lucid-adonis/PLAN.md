...
1. Review and accept ADR-0010/ADR-0013, then freeze peer ranges and public names.
...
6. Extend safe CLI templates/detection, add generic Knex and Adonis/Lucid examples, and run production
   HTTP/Japa/PostgreSQL/package-consumer evidence on the common Node 24 baseline.
