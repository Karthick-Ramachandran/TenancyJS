...
2. Review the change and identify changed modules and generated outputs.
3. Compare changes against accepted ADRs and repository decisions.
4. Compare changes against module boundaries.
5. Check for new dependencies and security-sensitive changes.
6. Check whether tests and docs were updated.
7. Classify findings.
