...
3. Check path validation, overwrite policy, symlink policy, and dry-run behavior.
4. Check dependency, package, template, and preset risk.
5. Check for network, telemetry, secrets, `.env`, cloud, AI API, or runtime MCP behavior.
6. Check tests for security-sensitive behavior.
7. Classify findings as blockers, risks, or documented acceptable tradeoffs.
