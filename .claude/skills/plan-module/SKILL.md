---
name: plan-module
description: "Plan a module as a mini product by creating feature delivery docs, module memory, acceptance criteria, architecture impact, test plan, and ordered tasks before implementation. Use when building a whole new module or materially redesigning an existing one — and only then; not for adding a small component, helper, endpoint, or fix to an existing area, which should just be implemented with focused tests."
---
