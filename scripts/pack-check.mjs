  ...
  run(
    ...
    [
      ...
      [
        ...
        'const chain = new TenantResolutionChain({ resolvers: [new HeaderTenantResolver()], store: { find: async () => [{ tenant: fixture, status: "active" }] }, authorize: () => true });',
        'const outcome = await chain.resolve({ headers: { "x-tenant-id": "consumer" } }, { principal: { id: "u1" } });',
