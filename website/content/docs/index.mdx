...
<Cards>
  ...
  <Card title="Capability matrix" href="/docs/capability-matrix">
...
<Cards>
  <Card title="Tenant context" href="/docs/tenant-context">
...
<Cards>
  <Card title="Single database (row-level)" href="/docs/row-level">
    Shared tables + tenant_id, enforced by forced Postgres RLS or query-scoping.
  </Card>
  <Card title="Schema per tenant" href="/docs/schema-per-tenant">
    One Postgres schema per tenant via transaction-local search_path.
  </Card>
  <Card title="Database per tenant" href="/docs/database-per-tenant">
