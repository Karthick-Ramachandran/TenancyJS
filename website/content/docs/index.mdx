...
> **On MySQL or MongoDB?** Row-level is your path — schema- and database-per-tenant are PostgreSQL-only.
> The [capability matrix](/docs/concepts/capability-matrix#by-database) breaks it down by database.
