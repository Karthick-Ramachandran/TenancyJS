...
description: One PostgreSQL schema per tenant in a shared database, wired and provisioned. Copy-pasteable integration-agent prompt plus a one-line swap for every ORM.
---
...
provisions it for you. It works for a **new or existing** app - the integration-agent prompt below
...
edit your repo and run commands - it assesses your app first, integrates with what already exists, and
